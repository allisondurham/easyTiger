    ...
    return (
        ...
        <div className="home mt-0   relative">
            ...
            <div class="container  ">
                ...
                <div class="  my-4 p-2 flex justify-around text-stone-400 bg-stone-800/80 p-4 z-0 rounded-2xl">
                ...
                <div class=" my-4 p-2 mb-20 flex justify-around text-stone-400 bg-stone-800/80 p-4 z-0 rounded-2xl">
                    <a href="https://www.shakorihillsgrassroots.org/"
                        className="justify-start self-center"
                    >
                        <img
